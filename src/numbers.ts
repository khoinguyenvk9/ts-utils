 ...
 */
export function parseIntSafe(value: string | number, defaultValue: number = 0): number {
 ...
 */
export function parseFloatSafe(value: string | number, defaultValue: number = 0): number {
 ...
 */
export function minValue(value: number, minVal: number): number {
 ...
 */
export function maxValue(value: number, maxVal: number): number {
 ...
 */
export function toFixedNumber(value: number, precision: number = 10): number {
 ...
 */
export function areEqual(a: number, b: number, tolerance: number = 1e-10): boolean {
 ...
 */
export function toCompact(value: number, decimals: number = 1): string {
 ...
 */
export function toWordsVietnamese(num: number): string {
  if (num === 0) return 'không';

  const ones = ['', 'một', 'hai', 'ba', 'bốn', 'năm', 'sáu', 'bảy', 'tám', 'chín'];
  const scales = ['', 'nghìn', 'triệu', 'tỷ'];

  function convertHundreds(n: number, isFirstGroup: boolean = false): string {
    let str = '';
  ...
  if (num < 0) return 'âm ' + toWordsVietnamese(-num);
